...
final class Version20210430063007 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , name VARCHAR(30) NOT NULL, description VARCHAR(100) DEFAULT NULL, modified DATETIME DEFAULT NULL, created DATETIME NOT NULL --(DC2Type:datetime_immutable)
        , PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE customer (id CHAR(36) NOT NULL --(DC2Type:uuid)
        , fullname VARCHAR(70) NOT NULL, address VARCHAR(70) DEFAULT NULL, city VARCHAR(50) DEFAULT NULL, email VARCHAR(70) DEFAULT NULL, zip_code INTEGER DEFAULT NULL, phone INTEGER NOT NULL, modified DATETIME DEFAULT NULL, created DATETIME NOT NULL --(DC2Type:datetime_immutable)
        , PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE product (id CHAR(36) NOT NULL --(DC2Type:uuid)
        , name VARCHAR(50) NOT NULL, amount INTEGER NOT NULL, price DOUBLE PRECISION DEFAULT NULL, modified DATETIME DEFAULT NULL, created DATETIME NOT NULL --(DC2Type:datetime_immutable)
        , PRIMARY KEY(id))');
        ...
        , name VARCHAR(25) NOT NULL, colour VARCHAR(50) DEFAULT NULL, modified DATETIME DEFAULT NULL, created DATETIME NOT NULL --(DC2Type:datetime_immutable)
        , PRIMARY KEY(id))');
        ...
        , username VARCHAR(15) NOT NULL, email VARCHAR(70) DEFAULT NULL, password VARCHAR(100) NOT NULL, last_session DATETIME DEFAULT NULL, modified DATETIME DEFAULT NULL, created DATETIME NOT NULL --(DC2Type:datetime_immutable)
        , PRIMARY KEY(id))');
